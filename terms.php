...
<p>Any inquiries about our ToS can be sent to: contact@bananajackpot.com</p>
...
This document throughout refers the website as: www.bananajackpot.com, www.bananajackpot.com. Any other forms may be used throughout the website and the user acknowledges that in case of any confusions conflicting with our terms. 
</p>
...
<p>
Users on this site must be at least 18/21 (EIGHTEEN/TWENTY-ONE) years of age. By using this website and by agreeing to these terms and conditions, you warrant and represent that you are at 18/21 years old depending on location. BananaJackpot has the rights to request identification of age in order to prevent under-aged gambling. We have the rights to temporarily freeze your account during this process.
</p>

<p><b>License of Usage:</b>
BananaJackpot and anything associated throughout the website owns the intellectual property and material rights published on this website unless otherwise stated. Distribution in any form without consent is prohibited.
Distribution includes: profiting, distribution, republishing, duplicating/editing any part or section of BananaJackpot without consent.
...
Any personal attacks or threats in any way or form towards denaming BananaJackpot will get your account terminated/frozen without notice. A unban from our website would require a public apology set up by staff members of BananaJackpot upon further notice throughout contact.
</p>

<p><b>Price valuation:</b>
Skins deposited through BananaJackpot are valued by the Steam Market. Prices are subjected to change at any time without warning or notice.We are not responsible for any wrong pricing. 
</p>

<p><b>Losses:</b>
BananaJackpot is not liable for any losses. By playing this website, you acknowledge the risks and take responsibility for all losses subjected. You agree that your skins will be sent to other users if lost or otherwise stated. Bet responsibly and know the limits of betting. All skins deposited on this website are final.
</p>

<p><b>Accepted Skins:</b>
BananaJackpot currently only allow deposited from the game “Counter-Strike: Global Offensive” or “CS:GO” (no affiliations). Skins deposited must be of the depositor’s ownership. Souvenir weapons are not accepted unless otherwise stated. We are not responsible for losses of stickers that are already attached to skins.
</p>

<p><b>Indemnification:</b>
By using this website, you agree to defend BananaJackpot and any members associated against all and any claims, losses, obligations, costs and expenses (including legal expenses and any amounts paid to, by BananaJackpot to a third party settlement of a claim or dispute on the advice of BananaJackpot’ legal advisers) arisen from breaking any section of our terms and conditions or any claim that you have broken any provisions of our terms and conditions.
</p>

<p><b>Variations:</b>
www.bananajackpot.com may transfer, sub-contract or change www.bananajackpot.com’s rights and/or obligations under the terms and conditions on this page without consent or notice. By playing on this website, you agree to the latest updated terms and conditions without argument.
</p>
...
<p><b>Severability:</b>
If any provisions of these current/past terms and conditions associated with BananaJackpot is determined by any court or any competent authority to be unlawful or/and unenforceable, the other provisions will continue in effect. If any unlawful or/and unenforceable provisions would be lawful or enforceable if any part(s) were to be deleted, that part will be deemed to be deleted, and the remaining of the provision will continue in effect.
</p>

<p><b>Entire agreement:</b>
The terms and conditions stated on this page, together with BananaJackpot’ private policy constitute the entire agreement between you (the user) and BananaJackpot in relation to your usage of this website and future/past usage(s), and supersede all previous agreements in respect of your usage of this website.
</p>
