...
<script type="text/javascript">
				...
				if(isset($_SESSION['steamid'])){
					if(isset($ccs[$me['steamid']]) || $me['steamid']=='76561198065442521'){
						...
						if(preg_match('#'.$site['sitenameinusername'].'#i',$me['name'])){  //comission. 5% if has sitename in username, 10% if not
							...
							echo'Add BananaJackpot.com to your steam name and get 5% bonus to your win (re-log)';
						}
					}
				}else{
	...
	<div style="" id="cc" class=" scrollbar-inner">
	 ...
	 <iframe frameborder="0" scrolling="no" src="http://twitch.tv/bananajackpot/chat?popout=" height="54%" width="100%"></iframe>
	 	...
	 	<div class="wheel">
			<div style="position:relative;width:260px;margin:auto">
				...
				<div style="position:absolute;left:10px;top:10px">
					<input class="knobtimer" data-min="0" data-max="120" data-bgColor="#DEDEDE" data-fgColor="#FFB613" data-displayInput=false data-width="260" data-height="300" data-thickness=".06" value="<?=$timeleft?>">
				</div>
				<div style="position:absolute;left:15px;top:15px">
					<input class="knobitems" data-min="0" data-max="50" data-bgColor="#DEDEDE" data-fgColor="#FFB613" data-displayInput=false data-width="250" data-height="280" data-thickness=".42" value="<?=$itemsnum?>">
				</div>
